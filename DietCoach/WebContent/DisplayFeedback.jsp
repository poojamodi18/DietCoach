...
<body class="">
  <%
		ArrayList<Feedback> feedbacks = (ArrayList<Feedback>) request.getAttribute("feedbacklist"); //
	%>
  <div class="wrapper ">
            ...
            <div class="collapse show" id="pagesExamples">
              <ul class="nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link active" href="DisplayUserFeedbackServlet">
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody id="tbody">
						...
						<tr>
							<td><%=f.getUsername()%></td>
							<td><%=f.getFeedback()%></td>
							<td><%int star=f.getRating();
								for(int i=0;i<star;i++){
									%><i class="material-icons" style="color:yellow;">grade</i><%
								}
							...
							<td class="text-right" style="width:130px;">
								<button type="button" class="btn btn-primary btn-link btn-sm" data-id="<%=f.getId()%>"
								 data-toggle="modal" data-target="#exampleModal" rel="tooltip" title="Delete Feedback" > <i class="material-icons">delete</i>
								 </button>
                          </td>
						</tr>
						<%}%>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      		Once the feedback is deleted, it will be removed from DietCoach webApp.
      </div>
  ...
  <script>
    $(document).ready(function() {
    	...
    	btn.on('click',function(){
    		...
    		userid = $this.data('id');
    		console.log(userid);
    		var url = "DeleteUserFeedbackServlet?id="+userid;
