...
<body class="">
  <%
		ArrayList<DietCategory> dietcategorylist = (ArrayList<DietCategory>) request
				.getAttribute("dietcategorylist"); //
	%>
  <div class="wrapper ">
      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse show" id="dietExamples">
              <ul class="nav">
                <li class="nav-item active">
                  <a class="nav-link active" href="dietCategoryDisplayServlet">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Diet Category</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title">Diet Category</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                  ...
                  <div class="material-datatables">
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody id="tbody">
                      	...
                      	<%
							for (DietCategory dc : dietcategorylist) {
						%>
						<tr>
							<td><%=dc.getDietcategoryid()%> </td>
							<td><%=dc.getCategoryname()%></td>
							<td class="text-right" style="width:120px;">
                            	<a href="UpdateDietCategoryServlet?id=<%=dc.getDietcategoryid()%>" class="btn btn-primary btn-link btn-sm"
                            	rel="tooltip" title="Update Query" > <i class="material-icons">edit</i>
								</a>
                          </td>
						</tr>
						<%}%>
