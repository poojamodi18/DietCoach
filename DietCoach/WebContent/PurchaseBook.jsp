<%@page import="com.beans.UserPurchase"%>
...
<body class="">
	<%
		...
		String purchases = (String) request.getAttribute("Purchases");
		ArrayList<UserPurchase> userPurchases = new ArrayList<UserPurchase>(); 
		if(purchases.equalsIgnoreCase("yes"))
		{
			userPurchases = (ArrayList<UserPurchase>) request.getAttribute("userPurchases");
		}
	%>
  <div class="wrapper ">
...
<!--                     <span class="sidebar-mini"> EP </span> -->
        ...
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link active" href="PurchaseBookServlet">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">eBook-Shelf</a>
          </div>
          <!-- Nav-file Start -->
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title">eBook Details</h4>
                </div>
                <div class='alert alert-primary alert-dismissible fade show' role='alert' style="margin: 16px;">
                <h4>Get Premium membership to read all the books for free, For more information <a href="MemberShip.jsp">click here</a></h4>
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr>
							...
							<th>eBook Name</th>
							<th>Author Name</th>
							<th class="disabled-sorting ">ebook</th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr>
							...
							<tbody id="tbody">
								...
								<tr>
									<td><img
										src="data:image/jpeg;base64,<%=b.getBookcoverString()%>"
										width="80px" height="100px" style="border-radius: 8px;">
									</td>
									<td><%=b.getBookName()%></td>
									<td><%=b.getAutherName()%></td>
									<td>
										<%
										if(purchases.equalsIgnoreCase("yes"))
										{
											int i=1;
										for(UserPurchase p: userPurchases){
											
												if(p.getProdunctId()==b.getBookId()){
													i=2;
												}
											}
											if(i==2){%>
											<a class="btn btn-primary" href="DownloadBookServlet?id=<%=b.getBookId() %>">Download</a>													
											<%
											}
											else{
												%>
												<button class="btn btn-primary" type="button" data-id="<%=b.getBookId() %>" 
												data-toggle="modal" data-target="#exampleModal" 
												data-price="<%=b.getPrice()%>"><%=b.getPrice() %> &#8377;</button>
												<%}
										}
										else if(purchases.equalsIgnoreCase("no")){	%>
										<button class="btn btn-primary" type="button" data-id="<%=b.getBookId() %>" 
												data-toggle="modal" data-target="#exampleModal" 
												data-price="<%=b.getPrice()%>"><%=b.getPrice() %> &#8377;</button>
												<%}%>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">Purchase Book</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
	        <form method="post" action="pgBookRedirect.jsp">
...
<!-- 				<label>txnAmount*</label> -->
				...
				<button type="submit" class="btn btn-primary pull-right" onclick="">Continue Purchase</button>
			</form>
	      </div>
	    </div>
	  </div>
  ...
  <script>
    $(document).ready(function() {
    	...
    	btn.on('click',function(){
    		...
    		$('input:hidden[name=TXN_AMOUNT]').val(price);
    		console.log(id);
    		console.log(price);
    		console.log(orderid);
    		
    		$.post('PurchaseBookServlet', {
    			id : id,
    			price : price,
    			orderid : orderid
  			});
