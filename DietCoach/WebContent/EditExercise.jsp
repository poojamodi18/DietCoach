<%@page import="com.beans.Exercise"%>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Update Exercise Details</a>
          </div>
						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-header card-header-primary">
									<h4 class="card-title">Update Exercise Details</h4>
								...
								<div class="card-body">
									...
									%>
									<form method="post" action="UpdateExerciseServlet" id="RegisterValidation">

										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label class="bmd-label-floating">Exercise
														Name*</label> <textarea class="form-control"
														name="name" aria-required="true" aria-invalid="true"
														required="true"><%=exercise.getName()%></textarea>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Calories*
														</label> <input type="number" class="form-control"
														name="calories" required="true"
														value="<%=exercise.getCalories()%>" aria-required="true" aria-invalid="true">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Duration(Minutes)*
														</label> <input type="number" class="form-control"
														name="minutes" aria-required="true" aria-invalid="true"
														value="<%=exercise.getMinutes()%>" required="true">
												</div>
											</div>
										</div>

										<input type="hidden"
											value="<%=exercise.getExerciseId()%>" name="id">
