...
<body class="">
  <%
		ArrayList<Exercise> exerciselist = (ArrayList<Exercise>) request
				.getAttribute("exerciselist"); //
	%>
  <div class="wrapper ">
            ...
            <div class="collapse show" id="tablesExamples">
              <ul class="nav">
                <li class="nav-item active">
                  <a class="nav-link active" href="DisplayExerciseServlet">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Exercise</a>
          </div>
                      ...
                      <tbody id="tbody">
						...
						<tr>
							...
							<td class="text-right" style="width:120px;">
                            	<a href="UpdateExerciseServlet?id=<%=ex.getExerciseId()%>" class="btn btn-primary btn-link btn-sm"
                            	rel="tooltip" title="Update Exercise Details" > <i class="material-icons">edit</i>
								</a>
                          </td>
						</tr>
						<%}%>
