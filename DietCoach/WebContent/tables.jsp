            ...
            <div class="collapse show" id="pagesExamples">
              <ul class="nav">
                <li class="nav-item active">
                  <a class="nav-link active" href="UserListServlet">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="material-datatables">
                      ...
                      <tbody id="tbody">
						...
						<tr>
							...
							<td class="text-right" style="width:130px;">
								<a href="ViewUserProfileServlet?id=<%=u.getUserId()%>" rel="tooltip" title="View Full Profile"
									class="btn btn-primary btn-link btn-sm"> 
									<i class="material-icons">dvr</i></a>
								<button type="button" class="btn btn-primary btn-link btn-sm" data-id="<%=u.getUserId()%>"
								 data-toggle="modal" data-target="#exampleModal" rel="tooltip" title="Delete User" > <i class="material-icons">delete</i>
								 </button>
                          </td>
						</tr>
						<%}%>
                    ...
                    <a href="ShowDeletedUserServlet" class="btn btn-primary">Deleted Users</a>
                  </div>
                </div>
                <!-- end content-->
              </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      		Once the user is deleted, the user will be not able to use Diet Coach webApp.
      </div>
  ...
  <script>
    $(document).ready(function() {
    	...
    	btn.on('click',function(){
    		...
    		userid = $this.data('id');
    		console.log(userid);
    		var url = "DeleteUserProfile?id="+userid;
