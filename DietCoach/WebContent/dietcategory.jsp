            ...
            <div class="collapse show" id="dietExamples">
              <ul class="nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link active" href="DietCategoryServlet">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">New Diet Category</a>
          </div>
						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-header card-header-primary">
									<h4 class="card-title">Insert New Diet Category</h4>
									<p class="card-category"></p>
								</div>
								<div class="card-body">
									<form method="post" action="DietCategoryServlet">
										<div class="row">
											<div class="col-md-12">
