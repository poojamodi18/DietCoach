      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Update Diet Category</a>
          </div>
						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-header card-header-primary">
									<h4 class="card-title">Update Diet Category</h4>
									<p class="card-category"></p>
								</div>
								<div class="card-body">
									<%
										DietCategory dietCategory = (DietCategory) request.getAttribute("dietcategorydetails");
									%>
									<form method="post" action="UpdateDietCategoryServlet">

										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label class="bmd-label-floating">Diet Category
														Name</label> <input type="text" class="form-control"
														name="categoryname"
														value="<%=dietCategory.getCategoryname()%>">
												</div>
											</div>
										</div>

										<input type="hidden"
											value="<%=dietCategory.getDietcategoryid()%>" name="id">
