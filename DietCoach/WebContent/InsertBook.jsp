            ...
            <div class="collapse show" id="formsExamples">
              <ul class="nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link active" href="InsertBook.jsp">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Add eBook</a>
          </div>
            ...
            <div class="row">
						...
						<div class="col-md-8 ">
							<div class="card">
								...
								<div class="card-body">
									<form method="post" action="InsertBookServlet" enctype="multipart/form-data">
										
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Book Name</label> <input
														type="text" class="form-control" name="bookname">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Author Name</label> <input
														type="text" class="form-control" name="authorname">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Book Price &#8377;</label> <input
