                ...
                <div class="card card-product">
                  ...
                  <div class="card-body">
                    <div class="card-actions text-center">
                      ...
                      <a href="UserDisplayBookServlet" class="btn btn-primary btn-link" rel="tooltip" data-placement="bottom" title="View">
                        <i class="material-icons">art_track</i>
                      </a>
                    </div>
                    <h4 class="card-title">
                      <a href="UserDisplayBookServlet">eBooks</a>
                    </h4>
                    <div class="card-description">
                ...
                <div class="card card-product">
                  ...
                  <div class="card-body">
                    <div class="card-actions text-center">
                      ...
                      <a href="UserDisplayExerciseServlet" class="btn btn-primary btn-link" rel="tooltip" data-placement="bottom" title="View">
                        <i class="material-icons">art_track</i>
                      </a>
                    </div>
                    <h4 class="card-title">
                      <a href="UserDisplayExerciseServlet">Workout & Exercise</a>
                    </h4>
                    <div class="card-description">
