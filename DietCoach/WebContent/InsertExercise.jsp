            ...
            <div class="collapse show" id="tablesExamples">
              <ul class="nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link active" href="InsertExercise.jsp">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Add Exercise Details</a>
          </div>
						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-header card-header-primary">
									<h4 class="card-title">Add Exercise Details</h4>
									<p class="card-category"></p>
								</div>
								<div class="card-body">
									<form method="post" action="InsertExerciseServlet" id="RegisterValidation">
