      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Revenue</a>
          </div>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-default card-header-icon">
                    ...
                    <p class="card-category">Plan Income &#8377;</p>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-default card-header-icon">
                    ...
                    <p class="card-category">Book Income &#8377;</p>
              ...
              <div class="col-md-12">
                <div class="card card-chart">
                  ...
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Income(&#8377;) in <script>document.write(new Date().getFullYear())</script></h4>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    $(document).ready(function() {
    	...
    	$.get('GetTotalIncome', {
			...
			$('#free').text(responseText);	
		});
    	$.get('GetTotalIncome', {
    		type : 'plan',
		}, function(responseText) {
			$('#premium').text(responseText);	
		});
    	$.get('GetTotalIncome', {
    		type : 'all',
		}, function(responseText) {
