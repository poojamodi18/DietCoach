...
<body class="off-canvas-sidebar">
    ...
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="javascript:;">Pick the best plan for you</a>
      </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="card card-pricing ">
              <h3 class="card-category"> 30 Days Free Trial</h3>
              <div class="card-body">
                <div class="card-icon icon-primary ">
                  <i class="material-icons">account_balance_wallet</i>
                </div>
                <h3 class="card-title">Free</h3>
                <p class="card-description">Free Plan only for 30 days with limited features<br>You need to purchase membership plan to continue using Diet Plan.<br><br><br><br></p>
              </div>
              <div class="card-footer justify-content-center ">
                <a href="Login.jsp" class="btn btn-round btn-primary">Continue</a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
