      ...
      <div class="sidebar-wrapper">
            ...
            <div class="collapse show" id="formsExamples">
              <ul class="nav">
                <li class="nav-item active">
                  <a class="nav-link active" href="DisplayeBook">
        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">eBook Details</a>
          </div>
...
<!-- 							<th style="width: 180px;" >Name</th> -->
							...
							<th class="disabled-sorting ">Image</th>
                         	<th class="disabled-sorting text-center" style="width: 50px;">Actions</th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr>
							...
							<tbody id="tbody">
								...
								<tr>
									...
									<td><%=b.getPrice() %> &#8377;</td>
									<td><a href="DownloadBookServlet?id=<%=b.getBookId() %>" >download</a></td>
									<td><img
										src="data:image/jpeg;base64,<%=b.getBookcoverString()%>"
										width="80px" height="100px" style="border-radius: 8px;"></td>
									<td>
					                    <button class="btn btn-primary btn-link btn-sm" data-toggle="modal" 
					                    data-target="#myModal10" data-id="<%=b.getBookId() %>" data-action="delete" 
					                    rel="tooltip" title="Delete eBook">
						  ...
						  <div class="modal-dialog" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						      		...
						      		<p>Once the eBook is deleted, All the related data will be deleted from the database of Diet Coach webApp.</p>
						      </div>
  ...
  <script>
    $(document).ready(function() {
    	...
    	btn.on('click',function(){
    		...
    		console.log(id);
    		console.log(act);
    		var url = "DeleteBookServlet?id="+userid;
