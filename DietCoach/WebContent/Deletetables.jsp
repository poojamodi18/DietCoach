						...
						<tr>
							...
							<td class="text-right" style="width:130px;">
								<button type="button" class="btn btn-primary btn-link btn-sm" data-id="<%=u.getUserId()%>"
								 data-toggle="modal" data-target="#exampleModal" rel="tooltip" title="Activate User" > <i class="material-icons">done</i>
								 </button>
                          </td>
						</tr>
						<%}%>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      		Once the previously removed user is activated, the user will be able to use Diet Coach webApp again.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a href="" id="deletebtn" class="btn btn-primary">Activate</a>
      </div>
    </div>
  </div>
</div>
  ...
  <script>
    $(document).ready(function() {
    	...
    	btn.on('click',function(){
    		...
    		userid = $this.data('id');
    		console.log(userid);
    		var url = "ActivateUserProfile?id="+userid;
