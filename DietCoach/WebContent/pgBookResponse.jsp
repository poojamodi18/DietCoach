      ...
      <div class="container">
		...
		<div class="card card-nav-tabs text-center">
  			...
  			<div class="card-body">
    			...
    			<p class="card-text">Click on below button to get your eBook.</p>
    			<a href="PurchaseBookServlet" class="btn btn-primary" id="done">Done</a>
  			</div>
		...
		<%
			...
			<div class="card card-nav-tabs text-center">
  			...
  			<div class="card-body">
    			...
    			<p class="card-text">Oops! Looks like the payment process failed.</p>
    			<a href="PurchaseBookServlet" class="btn btn-primary">Go Back</a>
  			</div>
  			<div class="card-footer text-muted">
