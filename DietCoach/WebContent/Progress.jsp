...
<!--                     <span class="sidebar-mini"> EP </span> -->
          ...
          <div class="container-fluid">
                ...
                <div class="card">
                  <div class="card-header card-header-icon card-header-primary">
                    ...
                    <h4 class="card-title">Today's Diet - 
                    	<small id="total"></small><small> Calories Eaten</small> & <small id="exer"></small><small> Calories Burned</small>
                    </h4>
                  </div>
                  <div class="card-body">
            ...
            <div class="row" >
			  <div class="col-md-12">
                  ...
                  <div class="card-footer">
                  	<div>
                    <button class="btn btn-info btn-sm" type="button">Eaten</button>
                    <button class="btn btn-danger btn-sm" type="button">Burned</button>
                   	</div>
                  </div>
                </div>
			  </div>
  ...
  <script>
    $(document).ready(function() {
    	...
    	function gentoday() {
    		var data = {
    				  labels: ['Breakfast', 'Lunch', 'Dinner', 'Snack', 'Exercise'],
    				  series: [
    				    [bre, lun, din, sn, ex]
    				  ]
    				};
    	...
    	$.get('GetExerciseValueServlet', {
		}, function(responseText) {
			ex = parseInt(responseText);
			$('#exer').text(ex);
			gentoday();
		});
		...
		$.post('GetExerciseValueServlet', {
    		day : '0'
		}, function(responseText) {
			e1 = parseInt(responseText);
			weeklygen();
		});
		$.post('GetExerciseValueServlet', {
    		day : '1'
		}, function(responseText) {
			e2 = parseInt(responseText);
			weeklygen();
		});
		$.post('GetExerciseValueServlet', {
    		day : '2'
		}, function(responseText) {
			e3 = parseInt(responseText);
			weeklygen();
		});
		$.post('GetExerciseValueServlet', {
    		day : '3'
		}, function(responseText) {
			e4 = parseInt(responseText);
			weeklygen();
		});
		$.post('GetExerciseValueServlet', {
    		day : '4'
		}, function(responseText) {
			e5 = parseInt(responseText);
			weeklygen();
		});
		$.post('GetExerciseValueServlet', {
    		day : '5'
		}, function(responseText) {
			e6 = parseInt(responseText);
			weeklygen();
		});
		$.post('GetExerciseValueServlet', {
    		day : '6'
		}, function(responseText) {
			e17 = parseInt(responseText);
			weeklygen();
		});
    });
  </script>
