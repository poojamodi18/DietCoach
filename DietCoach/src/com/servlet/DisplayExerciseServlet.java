...
/**
 * Servlet implementation class DisplayExerciseServlet
 */
public class DisplayExerciseServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
     ExerciseService exerciseService = new ExerciseServiceImpl();
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayExerciseServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("DisplayExercise.jsp");
